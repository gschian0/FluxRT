...
force_mediamtx_recovery() {
  ...
  (
    ...
    ENABLE_TTS_OVERLAY=1 AUDIO_SOURCE_MODE=url TTS_SOURCE_MODE=url \
    ...
    VIDEO_TRANSCODE_MODE=transcode VIDEO_BITRATE=550k VIDEO_MAXRATE=550k VIDEO_BUFSIZE=1100k \
